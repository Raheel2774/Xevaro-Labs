    ...
    <>
              ...
              return (
                <div key={i}>
                  <h3>
                    ...
                    >
                      <span className={`font-display text-lg font-medium transition-colors md:text-xl ${isOpen ? 'text-[#FFFFFF]' : 'text-[#FFFFFF]/85'}`}>
                        {f.q}
                      </span>
                      <span
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="max-w-2xl pb-7 text-[15px] leading-relaxed text-[#FFFFFF]/60">
                        {f.a}
                      </p>
                    </div>
                  </div>
      ...
      <section className="relative px-6 py-24 text-center md:px-10">
        <div className="mx-auto max-w-2xl">
          ...
          <Reveal delay={0.1}>
            <p className="mx-auto mt-6 max-w-lg text-lg font-light text-[#FFFFFF]/60">
          ...
          <Reveal delay={0.2}>
            <div className="mt-9 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <a href={`mailto:${CONTACT.email}`} className="font-mono text-sm text-[#FFFFFF]/60 transition-colors hover:text-[#B41D24]">
                {CONTACT.email}
              </a>
            </div>
          </Reveal>
