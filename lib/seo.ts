...
export const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'Xevaro Labs works across industries, with particular depth in ecommerce and retail, SaaS, professional services, home services and trades, and B2B companies that rely on outbound sales. Because automation logic is largely industry agnostic, the same core systems, AI agents, lead engines, and workflow automation, adapt to most business models.',
  },
  {
