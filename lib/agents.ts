...
export const NICHES: Niche[] = [
    ...
    agents: [
      {
        ...
        features: ['Sub-30s SMS response', 'Live calendar booking', 'Job-details capture'],
        outcome: 'Recover 30–50% of missed-call leads that used to vanish.',
      },
      {
        id: 'cleaning-quote',
        name: 'Instant Quote Agent',
        desc: 'Chats visitors through sq ft, rooms and frequency to return an instant estimate.',
        features: ['Dynamic price logic', 'Photo/room intake', 'Auto follow-up if idle'],
        outcome: 'Qualified quotes 24/7 with zero staff time.',
      },
      {
        id: 'cleaning-recurring',
        name: 'Recurring Booking Agent',
        desc: 'Handles reschedules, reminders and re-books recurring clients on autopilot.',
        features: ['Reminder + reschedule flow', 'No-show recovery', 'Loyalty re-book nudges'],
  ...
  },
  {
    ...
    agents: [
      {
        id: 'hvac-dispatch',
        name: 'Emergency Dispatch Triage Agent',
        desc: '24/7 agent that scores urgency, captures the issue and routes to the on-call tech.',
        features: ['Urgency scoring', 'Address + issue capture', 'On-call routing/SMS'],
      ...
      },
      {
        ...
        features: ['Post-job trigger', 'Google/Facebook links', 'Sentiment gate'],
        outcome: 'A steady flow of 5-star reviews that win local search.',
      },
      {
        id: 'hvac-maintenance',
        name: 'Seasonal Maintenance Agent',
        desc: 'Re-engages past customers for tune-ups and service plans each season.',
  ...
  },
  {
    ...
    agents: [
      ...
      },
      {
        ...
        features: ['Multi-touch follow-up', 'Objection handling', 'Re-quote booking'],
        outcome: 'More signed contracts from estimates you already gave.',
      },
      {
        id: 'roofing-financing',
        name: 'Financing Pre-Qual Agent',
        desc: 'Pre-qualifies homeowners for financing before the sales visit.',
    ...
    agents: [
      {
        ...
        name: 'Seasonal Quote & Booking Agent',
  ...
  },
  {
    ...
    agents: [
      ...
      },
      {
        ...
        features: ['Interval tracking', 'Personalized reminders', 'Re-book link'],
        outcome: 'Repeat visits that would otherwise be forgotten.',
      },
      {
        id: 'auto-upsell',
        name: 'Review & Upsell Agent',
        desc: 'Requests reviews and offers relevant add-on services post-visit.',
  ...
  },
  {
    ...
    agents: [
      {
        id: 'dental-booking',
        name: 'Booking & No-Show Recovery Agent',
      ...
      },
      {
        ...
        desc: 'Pre-qualifies insurance and coverage questions before the visit.',
        features: ['Coverage FAQ', 'Info collection', 'Front-desk handoff'],
        outcome: 'Smoother check-ins and fewer billing surprises.',
      },
      {
        id: 'dental-recall',
        name: 'Recall & Reactivation Agent',
        desc: 'Runs 6-month cleaning recalls and reactivates lapsed patients.',
        features: ['Recall automation', 'Lapsed-patient outreach', 'Confirm/reschedule'],
  ...
  },
  {
    ...
    category: 'Health & Wellness',
    icon: 'Syringe',
    tagline: 'Book high-ticket consults and nurture every lead.',
    agents: [
      {
        id: 'medspa-consult',
        name: 'Consultation Booking Agent',
        desc: 'Answers treatment questions and books consultations round the clock.',
        features: ['Treatment FAQ', 'Consult scheduling', 'Deposit collection'],
        outcome: 'A booked consult calendar for premium services.',
      },
      {
        id: 'medspa-nurture',
        name: 'High-Ticket Nurture Agent',
        desc: 'Nurtures leads over SMS toward high-value procedures.',
        features: ['Multi-touch nurture', 'Before/after sharing', 'Offer timing'],
        outcome: 'More closed high-ticket treatments.',
      },
      {
        id: 'medspa-membership',
        name: 'Membership & Loyalty Agent',
        desc: 'Drives membership renewals and rebooking of recurring treatments.',
        features: ['Renewal reminders', 'Loyalty perks', 'Rebook nudges'],
    ...
    agents: [
      {
        ...
        desc: 'Qualifies and schedules new patients with intake paperwork pre-filled.',
        features: ['Symptom intake', 'Scheduling', 'Form pre-fill'],
      ...
      },
      {
        ...
        features: ['Lapsed outreach', 'Re-eval offers', 'Booking link'],
    ...
    agents: [
      {
        ...
        outcome: 'Freed-up front desk and faster service.',
      },
      {
        id: 'vet-reminders',
        name: 'Vaccination Reminder Agent',
        desc: 'Sends vaccination and checkup reminders on the right schedule.',
        features: ['Vaccine schedule', 'Checkup recall', 'Confirm/reschedule'],
      ...
      },
      {
        ...
        outcome: 'Peace of mind for pet owners, fewer missed emergencies.',
      },
    ],
  },
  {
    ...
    category: 'Health & Wellness',
    icon: 'Dumbbell',
    tagline: 'Convert trials, win back cancels and fill classes.',
    agents: [
      {
        id: 'fitness-trial',
      ...
      },
      {
        ...
        outcome: 'Fuller classes and better member experience.',
      },
    ],
  },
  {
    ...
    agents: [
      ...
      },
      {
        ...
        desc: 'Books consultations and pre-collects relevant documents.',
      ...
      },
      {
        ...
        features: ['Status updates', 'FAQ handling', 'Escalation to staff'],
    ...
    agents: [
      {
        ...
        outcome: 'A calendar of pre-qualified prospects.',
      },
      {
        id: 'accounting-docs',
  ...
  },
  {
    ...
    category: 'Professional',
    icon: 'GraduationCap',
    tagline: 'Qualify applicants and book high-ticket discovery calls.',
    agents: [
      {
        id: 'coaches-discovery',
        name: 'Discovery Call Agent',
        desc: 'Qualifies leads and books discovery calls for high-ticket offers.',
      ...
      },
      {
        ...
        features: ['Magnet delivery', 'Nurture sequence', 'Call CTA timing'],
        outcome: 'A warm pipeline that books itself.',
      },
      {
        id: 'coaches-application',
        name: 'Application Review Agent',
        desc: 'Screens applications for high-ticket programs and routes the best fits.',
  ...
  },
  {
    ...
    category: 'Professional',
    icon: 'Megaphone',
    tagline: 'White-label agents for onboarding, reporting and lead-gen.',
    agents: [
      {
  ...
  },
  {
    ...
    agents: [
      ...
      },
      {
        ...
        features: ['Abandoned-cart recovery', 'Repeat-order nudges', 'Offer timing'],
  ...
  },
  {
    ...
    agents: [
      ...
      },
      {
        ...
        desc: 'Recovers abandoned carts across SMS and chat with smart offers.',
    ...
    agents: [
      {
        ...
        features: ['Inventory answers', 'Hours & location', 'Product guidance'],
      ...
      },
      {
        ...
        features: ['Loyalty sign-up', 'Targeted offers', 'Win-back'],
        outcome: 'Repeat visits and higher basket size.',
      },
      {
        id: 'retail-reservation',
        name: 'Reserve & Pickup Agent',
        desc: 'Handles in-store reservations and buy-online-pickup requests.',
    ...
    agents: [
      {
        id: 'realestate-qual',
        name: 'Lead Qualification Agent',
        desc: 'Qualifies buyers and sellers by budget, timeline and pre-approval.',
        features: ['Budget & timeline', 'Pre-approval check', 'Routing to agent'],
      ...
      },
      {
        ...
        features: ['Criteria matching', 'New-listing alerts', 'Showing CTA'],
  ...
  },
  {
    ...
    category: 'Property & Finance',
    icon: 'Landmark',
    tagline: 'Pre-qualify borrowers and keep files moving.',
    agents: [
      {
        id: 'mortgage-prequal',
        name: 'Pre-Qualification Agent',
        desc: 'Runs borrower intake and pre-qualification before the loan officer calls.',
        features: ['Intake questionnaire', 'Soft pre-qual', 'Officer routing'],
      ...
      },
      {
        ...
        name: 'Rate Re-Engagement Agent',
        desc: 'Re-engages past leads when rates or programs change.',
        features: ['Rate alerts', 'Refi outreach', 'Booking link'],
  ...
  },
  {
    ...
    agents: [
      ...
      },
      {
        ...
        desc: 'Identifies and pursues cross-sell opportunities (auto → home → life).',
  ...
  },
  {
    ...
    agents: [
      {
        id: 'pm-inquiry',
        name: 'Tenant Inquiry & Maintenance Agent',
        desc: 'Answers tenant questions and logs maintenance requests.',
        features: ['Leasing FAQ', 'Maintenance intake', 'Vendor routing'],
    ...
    agents: [
      {
        ...
        features: ['Roof & bill intake', 'Ownership check', 'Qualification'],
      ...
      },
      {
        ...
        features: ['Long nurture', 'Incentive timing', 'Re-engagement'],
  ...
  },
  {
    ...
    agents: [
      ...
      },
      {
        ...
        features: ['Trial nudges', 'Feature highlights', 'Upgrade CTA'],
  ...
  },
  {
    ...
    agents: [
      ...
      },
      {
        ...
        features: ['Multi-touch follow-up', 'Upsell add-ons', 'Booking push'],
...
// These are the highest-demand agents, featured on /best-sellers. They map to
// real agents in the catalog but are positioned as universal, productized heroes.
...
export const FLAGSHIP_AGENTS: Flagship[] = [
  {
    ...
    tagline: 'Every missed call and web lead answered in under 30 seconds — 24/7.',
    problem:
      '78% of customers buy from the business that responds first. Missed calls and slow replies quietly bleed revenue every single day.',
    how: [
      'Detects a missed call, form fill or DM the instant it lands',
    ...
    results: [
      { stat: '<30s', label: 'Response time' },
      { stat: '30–50%', label: 'More leads captured' },
  ...
  },
  {
    ...
    integrations: ['Calendly / Google Cal', 'Acuity', 'CRM', 'SMS + Email'],
    bestFor: 'Clinics, salons, agencies, trades — anyone booking appointments.',
  ...
  },
  {
    ...
    results: [
      ...
      { stat: '5★', label: 'Consistent experience' },
    ],
    integrations: ['Website Chat', 'WhatsApp', 'Email/Helpdesk', 'Voice'],
    bestFor: 'E-commerce, SaaS and any business with repetitive customer questions.',
    badge: 'Best Value',
  },
  {
    id: 'ai-followup',
    ...
    how: [
      ...
      'Re-engages old leads and stalled quotes automatically',
      'Books the meeting or re-quote the moment interest returns',
    ],
    results: [
      { stat: '2–3x', label: 'More closed deals' },
      { stat: '0', label: 'Leads left cold' },
      { stat: '$0', label: 'Extra ad spend' },
    ],
    integrations: ['CRM', 'SMS + Email', 'Calendar', 'Pipeline tools'],
    bestFor: 'Contractors, real estate, high-ticket services and B2B sales.',
    badge: 'Highest ROI',
  },
  {
    id: 'ai-reputation',
    ...
    tagline: 'Turns happy customers into a flood of 5-star reviews — automatically.',
    problem:
    ...
    how: [
      ...
      'Routes happy customers to Google & Facebook, catches unhappy ones first',
      'Drafts on-brand responses to every review',
      'Tracks rating trends so you always know where you stand',
    ],
    results: [
      { stat: '3–5x', label: 'More reviews' },
      { stat: '+0.5★', label: 'Average rating lift' },
      { stat: '#1', label: 'Local visibility push' },
    ],
    integrations: ['Google Business', 'Facebook', 'SMS + Email', 'CRM'],
