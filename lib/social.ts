...
// pricing and case-study pages. Keeping it here guarantees a consistent story.
//
// NOTE: TESTIMONIALS are realistic placeholders (role + industry, anonymized).
// Replace the quotes/attribution with real, permissioned client quotes as they
// come in — the structure stays the same.
...
export const TESTIMONIALS: Testimonial[] = [
  {
    quote:
      'Within the first week the missed-call agent booked jobs we would have lost. It paid for itself before we finished onboarding.',
    name: 'Marcus D.',
    role: 'Owner',
    industry: 'HVAC & Plumbing',
    result: '+38% booked jobs',
  },
  {
    quote:
      'Our front desk stopped drowning in scheduling. The booking agent handles it 24/7 and no-shows dropped off a cliff.',
    name: 'Dr. Priya S.',
    role: 'Practice Owner',
    industry: 'Dental',
    result: '−41% no-shows',
  ...
  {
    quote:
      'The follow-up agent revived quotes we had written off. It is the highest-ROI thing we have ever plugged in.',
    name: 'James T.',
    role: 'Sales Director',
    industry: 'Roofing',
...
// Headline company metrics — one source of truth (already used on the homepage).
...
export const INDUSTRIES_SERVED: string[] = [
  'Home Services', 'Healthcare', 'E-commerce', 'SaaS', 'Real Estate',
...
export const PROCESS: ProcessStep[] = [
  {
    step: '01',
    title: 'Audit',
    desc: 'A short discovery call to map your workflows and pinpoint the highest-ROI automation to build first.',
  },
  {
    step: '02',
    title: 'Architect',
...
// Guarantees / risk reversal — what makes buying safe.
...
export const PROMISES: Promise[] = [
  {
    ...
    desc: 'Most systems go live within one to two weeks — you see results fast, not after a long build.',
  },
  {
    icon: 'ShieldCheck',
    title: 'You own everything',
    desc: 'Self-hostable infrastructure on your accounts and data. No lock-in, no per-task SaaS tax.',
  },
  {
    icon: 'Wrench',
...
export const DIFFERENTIATORS: { title: string; desc: string }[] = [
  ...
  },
  {
    ...
    desc: 'We do not disappear at launch. Systems are monitored and improved continuously so ROI keeps climbing.',
  },
]
